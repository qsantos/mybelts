...
const resources = {
    en: {
        translation: {
            ...
            'exam.edit.button': '{{exam.id}}',
            'exam.edit.button.tooltip': '{{exam.filename}}',
            'exam.edit.title': 'Edit exam',
            'exam.edit.cancel': 'Cancel',
            'exam.edit.confirm': 'Save',
            'exam.edit.in_process': 'Saving',
            'exam.edit.open': 'Open',
            'exam.edit.filename.title': 'Filename',
            'exam.edit.filename.help': 'The filename used when downloading this test sheet',
            'exam.edit.skill_domain.title': 'Skill domain',
            'exam.edit.skill_domain.help': 'The skill domain tested by this test sheet',
            'exam.edit.belt.title': 'Belt',
            'exam.edit.belt.help': 'The belt corresponding to this test sheet',
    ...
    fr: {
        translation: {
            ...
            'exam.add_edit.filename.placeholder': 'exam.pdf',
