...
export function CreateStudentButton(
    props: CreateStudentButtonProps
): ReactElement {
...
export function DeleteStudentButton(
    props: DeleteStudentButtonProps
): ReactElement {
...
export function UpdateStudentRanks(
    props: UpdateStudentRanksProps
): ReactElement {
...
export function AddToWaitlistButton(
    props: AddToWaitlistButtonProps
): ReactElement {
...
export function RemoveFromWaitlistButton(
    props: RemoveFromWaitlistButtonProps
): ReactElement {
