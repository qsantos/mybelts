...
export function CreateSchoolClassButton(
    props: CreateSchoolClassButtonProps
): ReactElement {
...
export function EditSchoolClassButton(
    props: EditSchoolClassButtonProps
): ReactElement {
...
export function DeleteSchoolClassButton(
    props: DeleteSchoolClassButtonProps
): ReactElement {
...
export function SchoolClassListing(
    props: SchoolClassListingProps
): ReactElement {
...
export function SchoolClassExamsPDFButton(
    props: SchoolClassExamsPDFButtonProps
): ReactElement {
...
export function SchoolClassWaitlist(
    props: SchoolClassWaitlistProps
): ReactElement | null {
...
export function ManageClassWaitlistButton(
    props: ManageClassWaitlistButtonProps
): ReactElement {
    const {
        student,
        skill_domain,
...
export function ManageClassWaitlist(
    props: ManageClassWaitlistProps
): ReactElement {
    const {
        class_level,
        school_class,
