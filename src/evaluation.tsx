...
export function CreateEvaluationButton(
    props: CreateEvaluationButtonProps
): ReactElement {
...
export function EditEvaluationButton(
    props: EditEvaluationButtonProps
): ReactElement {
    const {
        evaluation,
        student,
...
export function DeleteEvaluationButton(
    props: DeleteEvaluationButtonProps
): ReactElement {
