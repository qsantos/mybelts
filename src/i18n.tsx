...
const resources = {
    ...
    fr: {
        translation: {
            ...
            'exam.delete.message': 'Êtes-vous sûr de vouloir supprimer cette évluation ?',
            ...
            'skill_domain.add_edit.code.title': 'Code',
            'skill_domain.add_edit.code.placeholder': 'Exaeple : D1',
            'skill_domain.add_edit.code.help': 'Identifiant simple pour le domain de compétences',
