...
export function CreateClassLevelButton(
    props: CreateClassLevelButtonProps
): ReactElement {
...
export function EditClassLevelButton(
    props: EditClassLevelButtonProps
): ReactElement {
...
export function DeleteClassLevelButton(
...
export function ClassLevelExamBulkUpload(
    props: ClassLevelExamBulkUploadProps
): ReactElement {
